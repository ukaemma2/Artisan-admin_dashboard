...
const add = ({ userRes, artizans, token }) => {
  ...
  const handleCreateServiceRequest = async (e) => {
    ...
    try {
      await authAxios(token).post(`/admins/service_requests/create`, serviceRequest);
      setLoading(false);
          ...
          <Grid item xs={12} sm={12} md={8}>
            <Card>
              <CardHeader color="primary">
                <h4 className={classes.cardTitleWhitew}>Add Service Request</h4>
                  ...
                  >
                    ...
                    >
                      ...
                      <FormControl className={classes.formControl}>
                        ...
                        >
                          {userRes.map((userRe) => (
                            <MenuItem key={userRe._id} value={userRe}>
                      ...
                      <FormControl className={classes.formControl}>
                        ...
                        >
                          {artizans.map((artizan) => (
                            <MenuItem key={artizan._id} value={artizan}>
